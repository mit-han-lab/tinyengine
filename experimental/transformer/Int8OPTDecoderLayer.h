...
class Int8OPTDecoderLayer {
   public:
    Int8OPTDecoderLayer(std::string param_path, int embed_dim, int num_heads, int hidden_dim,
                        struct LayerNormQ_params &self_attn_layer_norm, struct LayerNormQ_params &final_layer_norm,
                        struct W8A8B8O8Linear_params &fc1, struct W8A8BFP32OFP32Linear_params &fc2,
    ...
    struct LayerNormQ_params self_attn_layer_norm;  // from torch_int.nn
    struct W8A8B8O8Linear_params fc1;
    struct W8A8BFP32OFP32Linear_params fc2;
    struct LayerNormQ_params final_layer_norm;

...
void test_LayerNormQ_1_3B() {
    ...
    assert(check_two_equal(output_arr, GToutput_arr, b * m * n, 0.028));
...
void test_W8A8B8O8Linear_1_3B() {
    const int b = 1, m = 108, k = 2048, n = 2048;
    const float alpha = 0.00124359130859375, beta = 0.0217132568359375;
    MemoryAllocator mem_buf;
...
void test_BMM_S8T_S8N_F32T_1_3B() {
    ...
    const float alpha = 0.0011157989501953125;
    MemoryAllocator mem_buf;
    ...
    assert(check_two_equal(output_arr, GToutput_arr, GToutput.length()));

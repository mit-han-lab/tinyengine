...
TEST_P(Conv1x1, Tinyegnine_pointwise_ch48) {
    ...
    convolve_1x1_s8_ch48_fpreq(input, input_x, input_y, input_ch, kernel, bias, scales, output_offset, input_offset,
...
INSTANTIATE_TEST_SUITE_P(Conv1x1s, Conv1x1,
                         ::testing::Values(
                             ...
                             std::make_tuple(5, 5, 96, 10, 1, 1, 1, 5, 5, 9, 10),
                             std::make_tuple(10, 10, 96, -10, 1, 1, 1, 10, 10, 10, 10)));

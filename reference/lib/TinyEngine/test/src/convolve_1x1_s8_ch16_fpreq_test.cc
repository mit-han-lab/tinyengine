...
TEST_P(Conv1x1, Tinyegnine_pointwise_ch16) {
    ...
    convolve_1x1_s8_ch16_fpreq(input, input_x, input_y, input_ch, kernel, bias, scales, output_offset, input_offset,
...
INSTANTIATE_TEST_SUITE_P(Conv1x1s, Conv1x1,
                         ::testing::Values(
                             // channel specific
                             std::make_tuple(5, 5, 16, 10, 1, 1, 1, 5, 5, 9, 10),
                             std::make_tuple(10, 10, 16, -10, 1, 1, 1, 10, 10, 10, 10),
                             std::make_tuple(5, 5, 32, 10, 1, 1, 1, 5, 5, 9, 10),
                             std::make_tuple(10, 10, 32, -10, 1, 1, 1, 10, 10, 10, 10)));

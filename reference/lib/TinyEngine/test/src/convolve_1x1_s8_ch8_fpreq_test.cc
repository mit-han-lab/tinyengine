...
TEST_P(Conv1x1, Tinyegnine_pointwise_ch8) {
    ...
    convolve_1x1_s8_ch8_fpreq(input, input_x, input_y, input_ch, kernel, bias, scales, output_offset, input_offset,
                              -128, 127, output, output_x, output_y, output_ch, runtime_buf);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        // channel specific
        std::make_tuple(5, 5, 8, 10, 1, 1, 1, 5, 5, 9, 10), std::make_tuple(10, 10, 8, -10, 1, 1, 1, 10, 10, 10, 10),
        std::make_tuple(5, 5, 16, 10, 1, 1, 1, 5, 5, 9, 10), std::make_tuple(10, 10, 16, -10, 1, 1, 1, 10, 10, 10, 10),
        std::make_tuple(5, 5, 24, 10, 1, 1, 1, 5, 5, 9, 10), std::make_tuple(10, 10, 24, -10, 1, 1, 1, 10, 10, 10, 10),
        std::make_tuple(5, 5, 48, 10, 1, 1, 1, 5, 5, 9, 10),

...
void depthwise_kernel5x5_stride2_inplace_kernel_CHW_fpreq(const uint16_t output_y, const uint16_t output_x,
...
tinyengine_status depthwise_kernel5x5_stride2_inplace_CHW_fpreq(
    ...
    for (c = 0; c < input_ch; c++) {
        ...
        depthwise_kernel5x5_stride2_inplace_kernel_CHW_fpreq(output_y, output_x, bias++, biasR++, ksrc, scales++,

...
- Setup PYTHONPATH, and run the codegen example of VWW: (To generate code for other models or update schemes, please refer to [Tiny Training](https://github.com/mit-han-lab/tiny-training))

...
void depthwise_kernel7x7_stride2_inplace_kernel_CHW(const uint16_t output_y, const uint16_t output_x,
                                                    const int32_t *bias, const int32_t *biasR, const q7_t *ksrc,
                                                    const float *scales, q7_t *output, const int32_t output_offset,
...
tinyengine_status depthwise_kernel7x7_stride2_inplace_CHW_fpreq(
    ...
    for (c = 0; c < input_ch; c++) {
        ...
        depthwise_kernel7x7_stride2_inplace_kernel_CHW(output_y, output_x, bias++, biasR++, ksrc, scales++, inplace_out,
...
void depthwise_kernel7x7_stride2_inplace_kernel_CHW(const uint16_t output_y, const uint16_t output_x,
                                                    ...
                                                    const float *scales, q7_t *output, const int32_t output_offset,
                                                    const int32_t activation_min, const int32_t activation_max,
                                                    q7_t *cols_8b_iterptr, const uint16_t column_x,
                                                    int channel_offset) {
#define STRIDE 2
    int i, j;

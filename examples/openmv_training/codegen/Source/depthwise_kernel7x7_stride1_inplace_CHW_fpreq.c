...
void depthwise_kernel7x7_stride1_inplace_kernel_CHW(const uint16_t output_y, const uint16_t output_x,
...
tinyengine_status depthwise_kernel7x7_stride1_inplace_CHW_fpreq(
    ...
    for (c = 0; c < input_ch; c++) {
        ...
        depthwise_kernel7x7_stride1_inplace_kernel_CHW(output_y, output_x, bias++, biasR++, ksrc, scales++, inplace_out,
